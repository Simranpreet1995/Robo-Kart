...
extern int Robotspeed = 120; 

void WheelAct(int nLf, int nLb, int nRf, int nRb, int nRs); // Initialising parametric function to control trolley wheels
...
static esp_err_t index_handler(httpd_req_t *req){
 ...
 page += "</p>";
 page += "<div align=center Class=\"slidecontainer\">\n\n <style>.slidecontainer {\n  width: 100%;\n}\n\n .slider {\n  -webkit-appearance: none;\n  width: 100%;\n  height: 25px;\n  background: #d3d3d3;\n  outline: none;\n  opacity: 0.7;\n  -webkit-transition: .2s;\n  transition: opacity .2s;\n}\n\n .slider:hover {\n  opacity: 1;\n}\n\n.slider::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  appearance: none;\n  width: 25px;\n  height: 25px;\n  background: #4CAF50;\n  cursor: pointer;\n}\n\n .slider::-moz-range-thumb {\n  width: 25px;\n  height: 25px;\n  background: #4CAF50;\n  cursor: pointer;\n}</style>\t\n\n  <input type=\"range\" min=\"1\" max=\"100\" value=\"50\" class=\"slider\" id=\"myRange\">\n  <p>Robot Speed: <span id=\"demo\"></span></p>\n</div>\n\n<script>\n var slider = document.getElementById(\"myRange\");\n var output = document.getElementById(\"demo\");\n output.innerHTML = slider.value;\n\n\n slider.oninput = function() {\n  output.innerHTML = this.value;\n  getsend(\"Value=\"+this.value);\n}\n</script>\n\n\n";

    return httpd_resp_send(req, &page[0], strlen(&page[0]));
}

static esp_err_t go_handler(httpd_req_t *req){
    WheelAct(HIGH, LOW, HIGH, LOW,120);
    Serial.println("Go");
    httpd_resp_set_type(req, "text/html");
    return httpd_resp_send(req, "OK", 2);
}
static esp_err_t back_handler(httpd_req_t *req){
    WheelAct(LOW, HIGH, LOW, HIGH,120);
    Serial.println("Back");
    httpd_resp_set_type(req, "text/html");
    return httpd_resp_send(req, "OK", 2);
}
...
static esp_err_t left_handler(httpd_req_t *req){
    WheelAct(HIGH, LOW, LOW, HIGH,120);
    Serial.println("Left");
    httpd_resp_set_type(req, "text/html");
    return httpd_resp_send(req, "OK", 2);
}
static esp_err_t right_handler(httpd_req_t *req){
    WheelAct(LOW, HIGH, HIGH, LOW,120);
...
static esp_err_t robotSpeed_handler(httpd_req_t *req){
...
void startCameraServer(){
    ...
    httpd_uri_t ledoff_uri = {
     ...
     httpd_uri_t robotSpeed_uri = {
        .uri       = "/Value",
        .method    = HTTP_GET,
        .handler   = robotSpeed_handler,
        .user_ctx  = NULL
    };
